...
| Composition      | Stable namespaced `fui-*` class hooks and enhancement of authored markup                    | Per-part props, arbitrary nesting where valid, and `asChild` polymorphism              |
